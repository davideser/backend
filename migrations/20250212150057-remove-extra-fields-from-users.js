...
module.exports = {
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.addColumn('Users', 'ragioneSociale', {
      type: Sequelize.STRING
    });
    await queryInterface.addColumn('Users', 'cap', {
      type: Sequelize.STRING
    });
    await queryInterface.addColumn('Users', 'pv', {
      type: Sequelize.STRING
    });
    await queryInterface.addColumn('Users', 'codiceFiscale', {
      type: Sequelize.STRING
    });
    await queryInterface.addColumn('Users', 'partitaIva', {
      type: Sequelize.STRING
    });
    await queryInterface.addColumn('Users', 'emailPartner', {
      type: Sequelize.STRING
    });
  }
};
